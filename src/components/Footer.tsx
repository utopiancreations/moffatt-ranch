    ...
    <footer className="bg-ranch-dark text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <div className="flex items-center justify-center md:justify-end">
                ...
                <p><a href="tel:+12094830048" className="hover:text-peach">(209) 483-0048</a></p>
              </div>
              <div className="flex items-center justify-center md:justify-end">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-peach" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-sm text-gray-400 text-center">
          ...
          <p className="mt-2">
            Built and maintained by <a href="https://utopiancreations.one" target="_blank" rel="noopener noreferrer" className="text-peach hover:text-white transition-colors">Utopian Creations</a>
          </p>
        </div>
      </div>
    </footer>
